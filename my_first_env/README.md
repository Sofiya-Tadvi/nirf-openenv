---
title: My First Env Environment Server
emoji: 🎻
colorFrom: blue
colorTo: pink
sdk: docker
...
# My First Env Environment

A simple test environment that echoes back messages. Perfect for testing the env APIs as well as demonstrating environment usage patterns.

## Quick Start

The simplest way to use the My First Env environment is through the `MyFirstEnv` class:
...
try:
    ...
    my_first_envenv = MyFirstEnv.from_docker_image("my_first_env-env:latest")
    ...
    for msg in messages:
        result = my_first_envenv.step(MyFirstAction(message=msg))
        print(f"Sent: '{msg}'")
    ...
    # Always clean up
    my_first_envenv.close()
```

That's it! The `MyFirstEnv.from_docker_image()` method handles:
